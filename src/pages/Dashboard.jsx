    ...
    <div className="mt-24">
      ...
      <div className="flex gap-10 flex-wrap justify-center">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780  ">
          <div className="flex justify-between">
            <p className="font-semibold text-xl">Actualizaciones de ingresos</p>
        ...
        <div>
          ...
          >
            <div className="flex justify-between items-center ">
              <p className="font-semibold text-white text-2xl">Ganancias</p>

              <div>
                <p className="text-2xl text-white font-semibold mt-8">$63,448.78</p>
                <p className="text-gray-200">Ganancia mensual</p>
              </div>
            </div>
      ...
      <div className="flex flex-wrap justify-center">
        <div className="md:w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Estadísticas Semanales</p>
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          <div className="flex justify-between">
            <p className="text-xl font-semibold">Marca médica profesional</p>
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="mt-10">
            ...
            />
            <div className="mt-8">
              <p className="font-semibold text-lg">¡Reacciona 18 próximamente!</p>
              <p className="text-gray-400 ">By Johnathan Doe</p>
              <p className="mt-8 text-sm text-gray-400">
                Esta será la pequeña descripción de las novedades que has mostrado
                aquí. Podría haber una gran información.
              </p>
              <div className="mt-3">
                <Button
                  color="white"
